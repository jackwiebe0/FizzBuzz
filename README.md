...
### AAAAAAAAAAHHHHHHHHHHHHH (pull this change)
...
strike you as either similar to or different from Python.
  - the main block must be specified and worked within
  - variables must be defined as their data type
  - modulo and many operations work the same as in Python
  - `and` is represented as `&&`
  - nesting is done with braces
  - semicolon at the end of each line
  - statements defining when a loop should stop must be in parentheses
